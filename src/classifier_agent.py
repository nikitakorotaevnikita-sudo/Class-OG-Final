...
приёмной или органа власти; управляющей компании, банка, застройщика.
Определи по контексту вокруг каждого адреса, чей он: рядом имя и фамилия заявителя,
подпись «С уважением», слова «мой», «обратный адрес», «прошу ответить на»,
«связаться со мной», «контактные данные» — адрес заявителя. Рядом должность,
название ведомства или организации, «отправитель», «приёмная» — адрес чужой.
